...
making use of ml algorithms
selects predictors based on importance yes
...
# run the RFE algorithm
results = rfe(Glass_num[,1:9], Glass_num[,10], sizes = c(1,3,5), rfeControl = control, method = "svmRadial")
...
results = step(lm(Glass_num[,1:9], Glass_num[,10],data=Glass),direction="backward")
